...
- [ ] 04-02-PLAN.md — Wave 1 (D-05/D-14): 7 authored motion3.json files for Teto + model3.json motion-group update + collision-prevention test
- [ ] 04-03-PLAN.md — Wave 1 (D-06/D-08/D-10/D-13): backend action vocabulary (action_map, extract_action, transformers wiring, Teto actionMap, prompt template)
- [ ] 04-04-PLAN.md — Wave 1 (D-07): standalone sidecar audio→params adapter (NeuroSync wrapper + DSP fallback) + smoke test
- [ ] 04-05-PLAN.md — Wave 2 (D-04/D-15): frontend rebuild from upstream Open-LLM-VTuber-Web with Option A patch + audio-RMS body-bob extension + bundle replacement (has manual checkpoint)
- [ ] 04-06-PLAN.md — Wave 3 (D-01/D-03): integrated manual smoke + vibes verdict sign-off
